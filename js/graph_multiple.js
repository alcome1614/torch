...
$(document).ready(function() {
    ...
    var nodeMinimumDegreeList = [1, 5,10,20,50,100];
...
function draw(graphDisplayed){
    ...
    if (graphDisplayed=='authors'){ var file='collaboration'}
    else if(graphDisplayed=='words'){ var file='keywords'} ;
